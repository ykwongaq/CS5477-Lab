...
def compute_homography_error_test():
    ...
    correct2=np.array([0.89333816,2.72870971,0.54554879,0.14323777,0.12301613,0.57911088, 0.3172226, 0.69924904])
...
def compute_homography_ransac_test(data_dir):
    ...
    stitched_estimated = warp_images_all([im1, im2], [homo_estimated, np.eye(3)])
    plt.figure(figsize=(12, 8))
